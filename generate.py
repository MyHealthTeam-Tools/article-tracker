...
function buildTypeDropdown(availTypes,countMap){
  ...
  allCb.style.cssText="flex-shrink:0;width:15px;height:15px;cursor:pointer;accent-color:#6366f1;margin-left:auto";
  allDiv.append(allSpan,allCb);
  ...
  availTypes.forEach(type=>{
    ...
    d.style.cssText="display:flex;align-items:center;gap:10px;padding:8px 12px;cursor:pointer;user-select:none;width:100%";
    cb.style.cssText="flex-shrink:0;width:15px;height:15px;cursor:pointer;accent-color:#6366f1;margin-left:auto";
    d.append(badge,pill,cb);
